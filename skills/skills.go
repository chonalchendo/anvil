...
//go:embed capturing-inbox distilling-learning extracting-skill-from-session implementing-plan opening-thread researching writing-issue writing-milestone writing-plan writing-product-design writing-system-design
var FS embed.FS
