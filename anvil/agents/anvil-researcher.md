...
This section encodes harness behaviour, not skill behaviour: it is duplicated in the `anvil-issue-worker`, `anvil-pr-reviewer`, and `anvil-pr-responder` agent contracts — edit all four together.
