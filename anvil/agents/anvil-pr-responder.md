...
This section encodes harness behaviour, not skill behaviour: it is duplicated in the `anvil-issue-worker`, `anvil-pr-reviewer`, `anvil-researcher`, and `anvil-issue-author` agent contracts — edit all five together.
