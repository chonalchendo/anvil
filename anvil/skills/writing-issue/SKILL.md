...
- **Convergence (Phase 1):** skip — an unattended finding arrives decisive (problem + goal + reproduction) by construction. If it is genuinely fuzzy, do not converge solo: capture it as an `inbox` item and stop.
