# Writing Product Design — Phases

Each phase has an explicit user gate. Don't skip them — gates are the load-bearing part. Each is an iteration loop; expect 1–2 reframes per phase. The SKILL.md quick-reference table is the index; this file owns the procedure.
